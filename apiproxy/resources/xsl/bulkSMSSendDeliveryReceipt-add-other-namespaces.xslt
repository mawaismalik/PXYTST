...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:tns="http://webservice.stc.comarch.com/" version="1.0">
  ...
  <xsl:template match="@*">
    ...
    <xsl:element name="ns:{local-name()}">
      ...
      <xsl:namespace name="ns" select="'com.comarch.crm.tag.service.extdatamodel.v26'"/>
  ...
  <xsl:template match="/soapenv:Envelope/soapenv:Body/tns:sims/tns:item">
    <xsl:element name="ns:{local-name()}">
  ...
  <xsl:template match="/soapenv:Envelope/soapenv:Body/tns:sims/tns:item/tns:simID">
    <xsl:element name="ns:{local-name()}">
  ...
  <xsl:template match="/soapenv:Envelope/soapenv:Body/tns:sims/tns:item/tns:pin">
    <xsl:element name="ns:{local-name()}">
