...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:tns="http://webservice.stc.comarch.com/" version="1.0">
  ...
  <xsl:template match="/soapenv:Envelope/soapenv:Body/tns:partyRoleIds/tns:item">
    <xsl:element name="ns:{local-name()}">
  ...
  <xsl:template match="/soapenv:Envelope/soapenv:Body/tns:businessUnitIds/tns:item">
    <xsl:element name="ns:{local-name()}">
  ...
  <xsl:template match="/soapenv:Envelope/soapenv:Body/tns:costCenterIds/tns:item">
    <xsl:element name="ns:{local-name()}">
